...
# ----------------------------------
module "vpc" {
    source = "git@github.com:nmedija/terraform-modules-aws.git//network/vpc"
...
module "public_subnet" {
    source = "git@github.com:nmedija/terraform-modules-aws.git//network/public_subnet"
...
module "nat_gateway" {
    source = "git@github.com:nmedija/terraform-modules-aws.git//network/nat_gateway"
    azs = "${keys(var.public_subnets)}"
...
module "management_subnet" {
    source = "git@github.com:nmedija/terraform-modules-aws.git//network/private_subnet"
...
# ------------
module "bastion" {
    source = "git@github.com:nmedija/terraform-modules-aws.git//network/bastion"
